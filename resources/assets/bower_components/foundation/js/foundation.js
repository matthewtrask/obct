...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.joyride = {
    ...
    expose : function () {
      ...
      el.data('expose-stylesheets', origCSS);
    ...
    un_expose : function () {
      ...
      origCSS = el.data('expose-stylesheets');
  ...
  Foundation.libs.reveal = {
    ...
    open : function (target, ajax_settings) {
      ...
      if (!modal.hasClass('open')) {
        ...
        if (typeof modal.data('stylesheets-top') === 'undefined') {
          modal.data('stylesheets-top', parseInt(modal.css('top'), 10))
    ...
    show : function (el, css) {
      ...
      if (css) {
        ...
        if (animData.pop) {
          ...
          var end_css = {
            top: $(window).scrollTop() + el.data('stylesheets-top') + 'px',
            opacity: 1
          };
        ...
        css.top = $(window).scrollTop() + el.data('stylesheets-top') + 'px';
