...
var map = {
  ...
  cssanimations : 'stylesheets-animation',
  boxshadow : 'stylesheets-boxshadow',
  cssgradients : 'stylesheets-gradients',
  opacity : 'stylesheets-opacity',
  cssreflections : 'stylesheets-reflections',
  textshadow : 'stylesheets-textshadow',
  csstransitions : 'stylesheets-transitions',
  hsla : 'css3-colors',
  rgba : 'css3-colors',
