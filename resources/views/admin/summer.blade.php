...
@section('content')
    ...
    @foreach($summerShows as $show)
        ...
        <div id="editModal_{{$show->id}}" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            <form method="post" enctype="multipart/form-data" action="{{url('/')}}/admin/summer/{{$show->id}}" id="editCamp">
                <h4 class="text-center">Edit {{ $show->show_title }}</h4>
                <div class="row">
                    <div class="small-12 columns">
                        <div class="row">
                            ...
                            <div class="small-9 columns">
                                <input type="text" name="show_title" id="right-label" placeholder="Camp Title" value="{{$show->show_title}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" name="ages" id="right-label" placeholder="Appropriate Ages" value="{{$show->ages}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" name="dates" id="right-label" placeholder="Camp Dates" value="{{$show->dates}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" name="time" id="right-label" placeholder="Camp Times" value="{{$show->time}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" name="cost" id="right-label" placeholder="Camp Cost (do not include $)" value="{{$show->cost}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" name="show_times" id="right-label" placeholder="Camp Show Times" value="{{$show->show_dates}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" name="show_link" id="right-label" placeholder="Camp Tickets Link" value="{{$show->show_link}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <textarea name="show_info" rows="4" id="right-label" placeholder="Camp Description">
                                    {{$show->show_info}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="small-9 columns">
                                <input type="checkbox" value="true" name="active" value="{{$show->active}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-7 small-offset-3 columns">
                                <button class="button red" id="editCamp" value="submit" name="submit">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
