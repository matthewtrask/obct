...
@section('content')
    ...
    <div class="image" id="hero">
        <img src="https://obct.nyc3.cdn.digitaloceanspaces.com/slideshow/little-mermaid-play.jpg" alt="OBCT Mermaid Group">
        <img src="https://obct.nyc3.cdn.digitaloceanspaces.com/slideshow/green-logo.png" alt="Off Broadway Logo">
        <img src="https://obct.nyc3.cdn.digitaloceanspaces.com/slideshow/island-show.jpg" alt="OBCT Island Show">
    </div>
